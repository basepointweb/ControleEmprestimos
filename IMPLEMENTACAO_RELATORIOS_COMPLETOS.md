...
- **Funcionalidade**: Formulário modal para filtrar dados do Relatório de Devoluções
- **Filtros Disponíveis**:
  - Data Inicial e Data Final (padrão: mês atual)
  - Congregação (ComboBox com opção "Todas")
  - Bem (ComboBox com opção "Todos")
...
- **Funcionalidade**: Geração e impressão do Relatório de Devoluções em A4
- **Formato**: Retrato (Portrait), tamanho A4 (827x1169)
- **Estrutura do Relatório**:
  - **Cabeçalho**: Título "Relatório de Devoluções"
  - **Filtros Aplicados**: Período, Congregação e Bem
  - **Resumo**:
